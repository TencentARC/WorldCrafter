...
if TYPE_CHECKING:
    from ..diffusers.transformer import WorldCoreTransformer3DModel
...
def patch_worldcore_transformer_ucpe(
...
def load_ucpe_camera_adapter_weights(transformer: WorldCoreTransformer3DModel, checkpoint_path: str):

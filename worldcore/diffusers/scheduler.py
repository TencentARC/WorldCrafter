...
@dataclass
class WorldCoreSchedulerOutput(BaseOutput):
...
class WorldCoreScheduler(SchedulerMixin, ConfigMixin):
    _compatibles = []
    order = 1
    ...
    def step_euler(
    ...
    ) -> WorldCoreSchedulerOutput | tuple:
        ...
        return WorldCoreSchedulerOutput(prev_sample=prev_sample)
    ...
    def step_unipc(
        ...
        return WorldCoreSchedulerOutput(
